...
export default function Header({}: Props) {
  ...
  return (
    <header className="header">
        <div className="container container-fluid-large d-flex flex-row align-items-stretch justify-content-between">
          <div id="begin" className="d-flex align-items-center justify-content-center">
            <Link href="/">
              <a className="header-logo d-flex align-items-center">
