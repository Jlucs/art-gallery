        ...
        <div className="container container-fluid d-flex flex-row align-items-center justify-content-between">
          ...
          <div id="end" className="d-flex align-items-center justify-content-center">
            <div className="social">
              <ul>
                <li>
                  <a href="https://www.facebook.com/profile.php?id=100087521328593&is_tour_dismissed=true" target="_blank" rel="noreferrer">
                ...
                <li>
                  <a href="https://twitter.com/Cherribstudio" target="_blank" rel="noreferrer">
                ...
                <li>
                  <a href="https://www.instagram.com/cherribstudio/" target="_blank" rel="noreferrer">
